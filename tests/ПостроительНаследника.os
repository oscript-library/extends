...
Процедура УНаследникаДоступныСобственныеМетоды() Экспорт
	...
	// Когда
	Результат = Наследник.ТестоваяДобавленнаяФункция();
...
&Тест
Процедура НаследникИмеетМетодРодителяСПараметрами() Экспорт
	...
	// Когда
	Результат = Наследник.ТестоваяФункцияСПараметрами(1, 2);
...
&Тест
Процедура НаследникПереопределяетМетодРодителяСПараметрами() Экспорт
	...
	// Когда
	Результат = Наследник.ТестоваяПереопределяемаяФункцияСПараметрами(1, 2);
